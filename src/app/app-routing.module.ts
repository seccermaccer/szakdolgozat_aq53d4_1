...
const routes: Routes = [
  ...
  { path: 'rating', loadChildren: () => import('./rating/rating.module').then(m => m.RatingModule),...canActivate(redirectToLogin) },
  { path: 'kommentek', loadChildren: () => import('./kommentek/kommentek.module').then(m => m.KommentekModule) },
  { path: 'sajat-komment', loadChildren: () => import('./sajat-komment/sajat-komment.module').then(m => m.SajatKommentModule),...canActivate(redirectToLogin) },
  ...
  { path: 'kereses', loadChildren: () => import('./kereses/kereses.module').then(m => m.KeresesModule) },
  { path: '**',
